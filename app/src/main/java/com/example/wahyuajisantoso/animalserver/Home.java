...
import com.example.wahyuajisantoso.animalserver.ViewHolder.MenuViewHolder;
        ...
        alertDialog.setPositiveButton("YA", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (newCategory != null)
                {
                    ...
                    Snackbar.make(drawer,"New Category"+newCategory.getName()+"Telah Ditambahkan",Snackbar.LENGTH_SHORT)
                            .show();
                }
               ...
               viewHolder.txtMenuName.setText(model.getName());
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //mengirim category id dan memulai activity baru
                        Intent animalList = new Intent(Home.this,AnimalList.class);
                        animalList.putExtra("CategoryId",adapter.getRef(position).getKey());
